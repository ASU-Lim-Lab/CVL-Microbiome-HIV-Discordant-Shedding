...
##Map QC'ed reads to viral contigs.##
...
##Repeat for each sample and join the outputs into a feature table, which will be the input for decontam (see DNA virome diversity R script).##
